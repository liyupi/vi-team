<template>
    <div id="updateTeam">
        <el-steps :active="step">
            ...
            <el-step title="修改头像" icon="el-icon-picture"></el-step>
            <el-step title="确认" icon="el-icon-success"></el-step>
        </el-steps>
        <transition name="el-fade-in-linear" mode="out-in">
            ...
            <div v-if="step === 3" key="step3">
                ...
                <div class="control">
                    <el-button @click="step--" class="prev"><i class="el-icon-arrow-left"></i> 上一步</el-button>
                    <el-button @click="updateTeam" class="next">修改 <i class="el-icon-arrow-right"></i></el-button>
                </div>
            </div>
        </transition>
    </div>
...
<style>
    ...
    /*团队图片上传*/
    #updateTeam .avatar-uploader {
        text-align: center;
    }

    #updateTeam .avatar-uploader .el-upload {
    ...
    #updateTeam .avatar-uploader .el-upload:hover {
        border-color: green;
    }

    #updateTeam .avatar-uploader-icon {
        font-size: 28px;
        color: #8c939d;
        width: 178px;
        height: 178px;
